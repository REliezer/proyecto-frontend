...
<body>
    ...
    <div class="menu m-5">
        ...
        <a class="btn" style="background-color: #037BD4; color: #FFFFFF" href="{{ route('admin.productos', [$idCategoria, $item->description, $item->idSubCategory]) }}">{{$item->description}}{{$idCategoria}}</a>
        @endforeach
    </div>
